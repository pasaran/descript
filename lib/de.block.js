...
function compileExpr(expr) {
    ...
    return (typeof expr === 'function') ? expr : no.jpath(expr);
}
...
de.Block.prototype.run = function(params, context) {
    ...
    //  FIXME: '.foo' возвращает объект JNode/JNodeset -- их нужно привести к boolean.
...
de.Block.Http.prototype._run = function(params, context) {
    ...
    return de.http.get(url, (this._extend) ? params : null, this.options.datatype);
};
...
de.Block.Call.prototype._run = function(params, context) {
    ...
    if (module) {
        ...
        try {
            ...
            return no.Promise.resolve( de.error({
                id: 'MODULE_CALL',
                message: e.message
            }) );
        }
...
de.Block.Value.prototype._run = function(params, context) {
    return no.Promise.resolve(this.value);
};
