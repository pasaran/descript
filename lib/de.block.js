...
de.Block.prototype.debug_start = function(context, msg) {
    return context.debug_start( this.debug_id() + ' ' + msg );
};

de.Block.prototype.debug_end = function(context, msg, t1) {
    context.debug_end( this.debug_id() + ' ' + msg, t1 );
};
...
de.Block.prototype.run = function(params, context) {
    ...
    var t1 = this.debug_start(context, 'started');
    promise.done(function() {
        that.debug_end(context, 'ended', t1);
    });
        ...
        if ( options.template && !(result instanceof de.Result.Error) ) {
            ...
            de.file.eval(filename, 'de', de.sandbox, context)
                .done(function(template) {
                    var t1 = context.debug_start('[template ' + JSON.stringify(filename) + '] started');
                    var r = template( result.object() );
                    context.debug_end('[template ' + JSON.stringify(filename) + '] ended', t1);
...
de.Block.Function.prototype.debug_start = no.nop;
de.Block.Function.prototype.debug_end = no.nop;
...
de.Block.Value.prototype.debug_start = no.nop;
de.Block.Value.prototype.debug_end = no.nop;
...
de.Block.Array.prototype.debug_start = no.nop;
de.Block.Array.prototype.debug_end = no.nop;
...
de.Block.Object.prototype.debug_start = no.nop;
de.Block.Object.prototype.debug_end = no.nop;
...
de.Block.Expr.prototype.debug_start = no.nop;
de.Block.Expr.prototype.debug_end = no.nop;
