...
de.Block.File.prototype._run = function(params, context) {
    ...
    return de.file.get(filename, options.datatype, options.outputtype);
};
...
de.Block.Http.prototype._run = function(params, context) {
    ...
    if (options.proxy) {
        ...
        //  FIXME: Выкидывать ненужные заголовки, оставлять все остальное.
        headers = {
    ...
    return de.http.get(url, query, headers, datatype, outputtype);
};
