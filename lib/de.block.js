...
de.Block.prototype._init = function(descript, options) {
    ...
    this.before = compileObject(options.before);
    this.after = compileObject(options.after);
    ...
    function compile(s, id) {
        ...
        return (typeof s === 'function') ? s : no.jpath.compile(s, id);
    }
...
de.Block.prototype.run = function(params, context) {
    ...
    if (_before) {
        for (var key in _before) {
            state[key] = _before[key](params, params, context);
        }
    }
    ...
    if (_after) {
        promise.then(function(result) {
            ...
            for (var key in _after) {
                state[key] = _after[key](obj, obj, context);
            }
        });
    }
...
de.Block.Include.prototype._run = function(promise, params, context) {
    ...
    var includes = this.descript._includes;
