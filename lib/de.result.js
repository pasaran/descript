...
de.Result.Raw = function(result, datatype, outputtype) {
    this.result = result;
...
//  У блока de.Result.Raw есть два флага: datatype и outputtype.
...
//  т.е. outputtype === 'json' (и по-прежнему datatype === 'text').
//
//  datatype может принимать одно из значений: 'json', 'text', 'html', 'binary',
//  а outputtype в данный момент может быть 'json' или undefined.
...
de.Result.Raw.prototype.write = function(stream, outputtype) {
    outputtype = outputtype || this.outputtype;

    if (this.datatype === 'json' || outputtype !== 'json') {
...
//  de.Result.HTML.prototype.datatype = 'html';
